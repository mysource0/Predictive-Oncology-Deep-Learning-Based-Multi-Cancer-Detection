...
OUTPUT_FILE="full_code.txt"         # Output file

# Directories to ignore
IGNORE_DIRS=("node_modules" "assets" "backup_assets" ".git" ".vscode" "dist" "build" "venv" "__pycache__" "ExamReadyFastAPI" "env")

# Filenames to ignore (applies anywhere in tree)
IGNORE_FILES=("vocab.txt" "special_tokens.txt" ".env" "full_code.txt" "model.h5")  # Added more files if needed

# File extensions to include
INCLUDE_EXTENSIONS=("py" "sql" "js" "jsx" "ts" "tsx" "css" "scss" "html" "txt" "md")
