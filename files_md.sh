...
IGNORE_DIRS=("node_modules" "assets" "backup_assets" ".git" ".vscode" "dist" "build" "venv" "__pycache__" "ExamReadyFastAPI")

# Filenames to ignore (applies anywhere in tree)
IGNORE_FILES=("vocab.txt" "special_tokens.txt" ".env")  # Added more files if needed

# File extensions to include
INCLUDE_EXTENSIONS=("py" "sql" "js" "jsx" "ts" "tsx" "css" "scss" "html" "txt" "env" "md")
